...
public class CreateNewPostByApiTest {
    ...
    final String userName = "inga1";
    final String userPassword = "123456qwerty";
    ApiHelper apiHelper = new ApiHelper();


    @Before
    public void deleteAllPosts(){
        apiHelper.deletePostsTillPresent(userName, userPassword);
    }


    @Test
    public void createNewPosts(){
        String token = apiHelper.getToken(userName, userPassword);
