...
public class TestDB {
    ...
    public void testDataFromDataBase() throws SQLException, ClassNotFoundException {
        List<Map<String, String>> dataFromSeleniumTable =
                mySqlDatabase.selectTableAsMap("select * from seleniumTable where login= 'G2taras'");
        logger.info(dataFromSeleniumTable);
  //      int numbersOfRows = mySqlDatabase.changeTable("INSERT INTO seleniumTable VALUES(999,'G1Nikolai','passwordNikolai')");
