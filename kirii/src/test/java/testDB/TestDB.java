...
public class TestDB {
    ...
    public void testDataFromDataBase() throws SQLException, ClassNotFoundException {
        List<Map<String, String>> dataFromSeleniumTable =
                mySqlDatabase.selectTableAsMap("select * from seleniumTable where login='G1Yaroslav'");
        logger.info(dataFromSeleniumTable);
        /*int numberOfRows = mySqlDatabase.changeTable("INSERT INTO seleniumTable VALUES(777, 'G1Yaroslav', 'PASS')");
