...
public class ApiHelper {
    ...
    public void deletePostsTillPresent(String userName, String passWord) {
        ...
        for (int i = 0; i < listOfPostsByUser.length; i++) {
            deletePostyId(userName, passWord, listOfPostsByUser[i].get_id());
            logger.info(String.format("Post with id %s and title was deleted",
    ...
    private void deletePostyId(String userName, String passWord, String id) {
