...
public class ApiHelper {
    ...
    public PostDTO[] getAllPostsByUserName(String userName) {
    ...
    public void deletePostsTillPresent(String userName, String passWord) {
        PostDTO[] listOfPostsByUser = getAllPostsByUserName(userName);
        ...
        Assert.assertEquals(0,getAllPostsByUserName(userName).length);
    }
